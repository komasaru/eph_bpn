...
describe EphBpn::Compute do
  ...
  context ".r_generic" do
    ...
    it { expect(subject).to match([
      [
        be_within(1.0e-16).of(0.9999999249822028    ),
        be_within(1.0e-20).of(0.00037815673593285463),
        be_within(1.0e-20).of(8.386341064878865e-05 )
      ], [
        be_within(1.0e-19).of(-0.0003781546609226004 ),
        be_within(1.0e-16).of( 0.9999999281930637    ),
        be_within(1.0e-21).of(-2.4757212843948782e-05)
      ], [
